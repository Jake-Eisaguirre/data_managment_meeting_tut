...
```{sql, connection = ribbitr_connection, output.var = location}
...
```{sql, connection = ribbitr_connection, output.var = region}
...
```{sql, connection = ribbitr_connection, output.var = large_pan_frogs}
